...
<p>However many of the add ons are legacy <a>add ons</a> so in order to use them extra steps are required as shown below: </p>
  <ol>
    <li>Clone this repo/download the files </li>
    <li>Download the <a>add ons</a> from <a href="https://drive.google.com/drive/folders/1cJYGMm6Aftqti8qN181DWwTC-rRK3Q2z?usp=drive_link">here</a> into the same directory as these files (legacy)</li>

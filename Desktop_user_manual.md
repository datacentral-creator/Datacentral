...
<h2>Projects</h2>
<p>The projects addon let's you view your projects. These are currently created using the mobile app and sent to your computer, where they can be sent back to other mobile apps (or the same mobile app) however you can interact with project information using the project addon on the server component. To use it press type "P" then press enter and wait for the project addon to activate.</p>
<p>Once the projects addon is initialised you can type "projects" and press enter to get a list of project then type the name of the project you want to view and press enter to see information about that project such as it's constitutent links.</p>

...
<img src="./Database_upload_menu.png" alt="Results button" width="200" height="400">
This is the menu for uploading and downloading databases via a JSON file (Data.json)

<details open>
 ...
 <details open>
  ...
  <ol>
    ...
    <li>Choose "Configure network" if you wish to run datacentral pm that computer or you can run Server.exe on one computer and run the GUI on another computer using "Connect to network"</li>
    <li>Create an account at localhost:3000 and create a podcast called "poddy"</li>
  </ol> 
 </details>
</details>
<details>

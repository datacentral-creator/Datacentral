...
<p>To connect the server component to the mobile app you will next need to configure the file server addon as demonstrated in the <a href="./Desktop_user_manual.md">Desktop user manual </a></p>
